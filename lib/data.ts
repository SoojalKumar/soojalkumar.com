...
const baseProjects: ProjectBase[] = [
  {
    ...
    date: "May 2026",
    subtitle: "Flutter + FastAPI water intelligence platform built for the H2O Hackathon Hacking the Supply challenge.",
    description:
    ...
    metrics: ["Hacking the Supply", "Three Water Signals", "Flutter Web", "FastAPI Backend"],
    problem:
    ...
    objectives: [
      "Build a hackathon-ready awareness and warning app for California water supply conditions.",
      "Explain why snowpack alone is no longer enough for modern water forecasting.",
      "Combine snowpack, precipitation, and reservoir storage into one readable outlook.",
      "Surface multi-signal alerts, trends, report summaries, and planning guidance for water managers, farmers, and citizens.",
    ...
    methodology: [
      "Used the H2O Hackathon challenge dataset, a synthetic-but-realistic dataset modeled after standard California water references.",
      "Classified snowpack as future water, precipitation as current conditions, and reservoir storage as the current supply buffer.",
      "Applied challenge thresholds for snowpack, precipitation, and reservoir conditions to generate plain-language risk states.",
    ...
    implementation: [
      ...
      "Data: H2O Hackathon synthetic-but-realistic snowpack, precipitation, and reservoir dataset",
      "Water metrics: snowpack percent of April 1 average, precipitation percent of average, reservoir percent capacity",
  ...
  },
  {
    ...
    objectives: [
      "Build a university-focused platform for course materials and study workflows.",
      "Support web and mobile study experiences through Next.js and Expo.",
      "Process uploaded PDFs, text files, Markdown, DOCX, PPTX, legacy office files, audio, and video.",
      "Generate notes, summaries, flashcards, quizzes, study guides, key concepts, and probable exam questions.",
      "Use retrieval and citations so AI chat answers stay grounded in uploaded material.",
      "Move long-running extraction, chunking, embedding, and generation work into background workers.",
    ],
    methodology: [
      "Organized the product as a pnpm monorepo with web, mobile, API, shared UI, and shared type packages.",
      "Built FastAPI routers and services around auth, universities, courses, enrollments, materials, processing jobs, notes, flashcards, quizzes, chat, transcripts, dashboard, and admin metrics.",
      "Designed a Celery pipeline that moves uploads through extraction, transcription, chunking, embeddings, notes, flashcards, quizzes, and completion states.",
      "Used SQLAlchemy models with PostgreSQL and pgvector for structured academic data, material chunks, and retrieval-ready embeddings.",
      "Abstracted LLM, embedding, speech-to-text, and storage providers so local mock mode and production providers can share the same app flows.",
    ],
    features: [
    ...
    implementation: [
      "Frontend: Next.js App Router, React 19, TypeScript, Tailwind CSS, React Query, and Recharts",
      "Mobile: Expo Router, React Native, TypeScript, React Query, and secure local storage",
      "Backend: FastAPI, Pydantic, SQLAlchemy 2.0, Alembic, domain routers, and service-layer architecture",
...
const caseStudyDetails: Record<string, ProjectCaseStudy> = {
  "hydra-h2o": {
    heroVisual: {
      ...
      items: ["Hacking the Supply", "Flutter Dashboard", "FastAPI /api Backend", "Three Water Signals", "AI Assistant"],
    },
    workflow: ["Challenge JSON/CSV Data", "Snowpack + Precipitation + Reservoir Signals", "Deterministic Risk Classification", "Dashboard + Alerts", "Optional AI Explanation", "User-Facing Water Outlook"],
    architecture: ["Flutter Web Frontend", "FastAPI Backend", "Supply Dashboard API", "Challenge Data Services", "Alerts / Forecast / Reports", "AI Assistant", "User-facing Water Outlook"],
    technicalGroups: [
      ...
      { title: "Challenge Data", items: ["Synthetic-but-realistic H2O Hackathon dataset", "Snowpack percent of April 1 average", "Precipitation percent of average", "Reservoir percent capacity", "Multi-signal water outlook logic"] },
      { title: "AI Layer", items: ["Groq API optional LLM integration", "AI-generated water outlook summaries", "Offline deterministic fallback", "Safety guard for source-number consistency"] },
    ...
    visuals: [
      {
        ...
        description: "Real screenshot from the running Flutter web app introducing the hackathon challenge idea: snowpack alone is no longer enough.",
        label: "Screenshot",
      ...
      },
      {
        ...
        description: "Real dashboard screenshot showing Hydra's Watch outlook and the three challenge signals: snowpack, precipitation, and reservoir storage.",
        label: "Screenshot",
      ...
      },
      {
        ...
        description: "Real alerts screen showing how the app turns volatile water signals into warning-style guidance.",
        label: "Screenshot",
      ...
      },
      {
        ...
        description: "Real trends screen comparing snowpack, precipitation, and reservoir conditions from the challenge data.",
        label: "Screenshot",
    ...
    challenges: [
      {
        challenge: "The challenge data combines different water signals with different meanings and thresholds.",
        solution: "Hydra separates snowpack as future water, precipitation as current conditions, and reservoirs as the supply buffer, then combines them into one water outlook.",
      },
      {
        challenge: "Water supply is volatile, and snowpack alone is no longer a reliable planning signal.",
        solution: "Hydra uses the Hacking the Supply framing to compare snowpack, precipitation, and reservoir storage together for a more complete picture.",
      },
      {
  ...
  "campusstudy-ai": {
    ...
    visuals: [
      {
        title: "Study Workspace Diagram",
        description: "Generated visual grounded in the latest repo routes for dashboard, courses, materials, notes, flashcards, quizzes, chat, and admin surfaces.",
        label: "Diagram",
      ...
      {
        title: "RAG + Citation Flow",
        description: "Workflow diagram based on the implemented chunking, embedding, scoped retrieval, citation, and chat response services.",
        label: "Workflow",
      ...
      },
      {
        ...
        description: "Architecture visual grounded in the Celery processing statuses for extraction, transcription, chunking, embeddings, notes, flashcards, quizzes, and completion.",
        label: "Architecture",
      ...
      },
      {
        ...
        description: "Backend route map based on the current FastAPI API domains for auth, courses, materials, processing, notes, flashcards, quizzes, chat, transcripts, dashboard, and admin.",
        label: "Architecture",
        image: "/project-assets/campusstudy-ai/api-surface.svg",
        alt: "CampusStudy AI FastAPI API surface map",
        source: "Generated from project structure",
        variant: "diagram",
      },
    ],
    challenges: [
      {
        challenge: "Students need notes, flashcards, quizzes, study guides, and AI help from the same course material, but these workflows are usually split across separate tools.",
        solution: "CampusStudy AI centralizes materials, courses, generated study assets, and chat workflows in one web/mobile study platform.",
      },
      {
        challenge: "AI study answers need to stay connected to the uploaded lecture or course source material.",
        solution: "The backend chunks uploaded content, stores retrieval-ready embeddings, and returns citation-grounded chat answers from scoped material, topic, or course context.",
      },
      {
        challenge: "Long-running extraction, transcription, embedding, and generation work can block the user experience.",
        solution: "A Celery worker pipeline moves materials through explicit processing statuses while the web app can track jobs and surface generated results when ready.",
      },
    ],
    preview: {
